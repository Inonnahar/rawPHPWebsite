        ...
        <form action="#" method="post" enctype="multipart/form-data" >
                    ...
                    <table class="table table-bordered" id="create_table">
                            ...
                            <tr>
                                ...
                                <td class="col-md-9"><input type="text" placeholder="Enter your title" class="form-control" name="name"></td>
                            </tr>
                            <tr>
                                <th class="col-md-3">Designation</th>
                                <td class="col-md-9"><input type="text" placeholder="Enter your title" class="form-control" name="designation"></td>
                            </tr>
                            <tr>
                                <th class="col-md-3">Description</th>
                                <td class="col-md-9"><input type="text" placeholder="Enter your sub-title" class="form-control" name="description"></td>
                            </tr>
...
if(isset($_POST['name'])){
    ...
    $insert_data = "INSERT INTO testimonial (name, designation, description, photo) VALUES ('name', '$designation' ,'$description', '$fname')";
